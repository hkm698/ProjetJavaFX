...
public class Navigation {
    ...
    public static void goTo(String fxmlPath) {
        try {
            if (primaryStage != null) {
                ...
                primaryStage.getIcons().add(new Image(Navigation.class.getResourceAsStream("/fsiAdministration/images/FSI_logo.png")));
    ...
    public static void goTo(String fxmlPath, Window currentWindow) {
        try {
            ...
            newStage.getIcons().add(new Image(Navigation.class.getResourceAsStream("/fsiAdministration/images/FSI_logo.png")));
